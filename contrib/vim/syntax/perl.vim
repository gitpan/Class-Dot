...
syn keyword perlStatementStorage	my local our property has extends composite state
...
syn keyword perlStatementFiledesc	binmode close closedir eof fileno getc lstat print printf say readdir readline readpipe rewinddir select stat tell telldir write nextgroup=perlFiledescStatementNocomma skipwhite
